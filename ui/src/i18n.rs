...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "composer.hint") => Some("Enter to send · Shift+Enter for newline"),
        ...
        (Locale::En, "artifact.meta.fasta") => Some("{lines} lines"),
        ...
        (Locale::Zh, "composer.hint") => Some("Enter 发送 · Shift+Enter 换行"),
        ...
        (Locale::Zh, "artifact.meta.fasta") => Some("{lines} 行"),
